                                ...
                                <ContentWrapper>
                                    <div className="content">
                                        ...
                                        <div className="right">
                                            ...
                                            <div className="overview"> <div className="heading">Overview</div>
                                                <div className="description">{data.overview}</div></div>
                                            <div className="info">
                                                ...
                                                {data.release_date && (<div className="infoItem">
                                                    ...
                                                    <span className="text">{dayjs(data.release_date).format("MM DD YYYY")}</span>
                                                </div>)}
